 ...
 *
 * <p>
 * Acts as a lightweight overlay that provides a GUI-based command interface
 ...
 * <li>The Forge {@code EVENT_BUS} for runtime game events (e.g., key
 * bindings)</li>
...
public class BaritoneCommandHub {
     ...
     *
     * <p>
     * Currently used only for a startup confirmation log. Future
